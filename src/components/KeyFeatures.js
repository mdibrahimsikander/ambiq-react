          ...
          <div className="col-md-6 col-lg-3">
            <div className="box ">
              ...
              <div className="detail-box">
                <h4>Accessible</h4>
                <p>
                  AmbiQ is accessible to anyone with a smarphone, making it
                  convenient for users to request emergency assistance anytime,
                  anywhere
                </p>
              </div>
            </div>
          ...
          <div className="col-md-6 col-lg-3">
            <div className="box ">
              ...
              <div className="detail-box">
                <h4>Cost Friendly</h4>
                <p>
                  We believe in making emergency medical services accessible to
                  all, which is why AmbiQ offers affordable rates for ambulance
                  bookings.
                </p>
              </div>
            </div>
